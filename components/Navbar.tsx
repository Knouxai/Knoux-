...
import { Menu, X, Shield, Globe, Moon, Sun } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button 
              ...
              className="bg-knoux-600 hover:bg-knoux-500 text-white px-5 py-2 rounded-full text-sm font-semibold shadow-[0_0_15px_rgba(91,33,182,0.3)] hover:shadow-[0_0_25px_rgba(139,92,246,0.5)] transition-all duration-300 border border-transparent dark:border-white/10"
            >
              {t.nav.accessConsole}
            </button>
          </div>
